...
//            this.life = DEFUALT_LIFE_HERO;
    ...
    public void move() {
        ...
        if (this.group == Group.VILLAIN && DirectionUtils.getRandom() > 95) {
            fire();
        }
        /** VILLAIN group change directions */
        if (this.group == Group.VILLAIN && DirectionUtils.getRandom() > 90) {
            changeDiretion();
        }
    ...
    private void changeDiretion() {
        if (this.group != Group.HERO) {
            this.dir = DirectionUtils.getRandomDirection();
        }
    }
